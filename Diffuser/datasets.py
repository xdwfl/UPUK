...
class MyDataset:
    ...
    def get_train_loader(self,all_fea,all_label,train_state):
        train_loader = torch.utils.data.DataLoader(
            self.get_train_data(all_fea,all_label,train_state),
    ...
    def get_loaders(self,all_fea,all_label,train_state):
        return self.get_train_loader(all_fea,all_label,train_state), self.get_test_loader()
...
class CustomDataset(MyDataset):
    ...
    def get_train_data(self,feas,labels,train_state):
        train_codes = feas.cpu()
        if self.args.transform_input_data:
            train_codes = transform_embeddings(self.args.transform_input_data, train_codes)
        if self.args.use_labels_for_eval or train_state=='only_optimize_w_semi':
