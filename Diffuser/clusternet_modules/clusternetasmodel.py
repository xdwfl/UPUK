...
from os_sfda.Diffuser.clusternet_modules.utils.plotting_utils import PlotUtils
from os_sfda.Diffuser.clusternet_modules.utils.training_utils import training_utils
from os_sfda.Diffuser.clusternet_modules.utils.priors import (
    Priors,
)
...
from os_sfda.Diffuser.clusternet_modules.utils.split_merge_operations import (
    update_models_parameters_split,
    split_step,
    merge_step,
    update_models_parameters_merge,
)
from os_sfda.Diffuser.clusternet_modules.Classifiers import MLP_Classifier, Subclustering_net
    ...
    def training_epoch_end(self, outputs):
        ...
        if self.split_performed or self.merge_performed:
            ...
            if self.split_performed:
                with open("/home/wfl/UPUK/os_sfda/log/os_sfda.txt", "a") as f:
                    f.write(f"Perform splitting, Current number of clusters: {self.K}\n")
            else:
                with open("/home/wfl/UPUK/os_sfda/log/os_sfda.txt", "a") as f:
                    f.write(f"Perform merging, Current number of clusters: {self.K}\n")
